...
public:
    ...
    bool huyacc(const std::vector<SParseRule>& lex_vec, 
                TStream& out_stream);
...
private:
    ...
    template<typename TStream>
    bool huyacc_enum(const std::vector<SParseRule>& lex_vec, 
                     TStream& out_stream);
    template<typename TStream>
    bool huyacc_array(const std::vector<SParseRule>& lex_vec, 
                      TStream& out_stream);
...
template<typename TStream>
bool CHuyacc::huyacc(const std::vector<SParseRule>& lex_vec, 
                     TStream& out_stream)
{
...
template<typename TStream>
bool CHuyacc::huyacc_enum(const std::vector<SParseRule>& lex_vec, 
                          TStream& out_stream)
{
    out_stream << "enum ERuleType" "\n";
    out_stream << "{" "\n";

    for (const auto& rule : lex_vec)
...
template<typename TStream>
bool CHuyacc::huyacc_array(const std::vector<SParseRule>& lex_vec, 
                           TStream& out_stream)
{
